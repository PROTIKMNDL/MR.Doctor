...
== Changelog ==
= 1.0.9 - January 09 2020 =
* Promo Section title tag empty replaced with category name
* Checked single page content design
* Fixed breadcrumb in mobile device
* Disable meta tags on blog page in default

= 1.0.8 - December 18 2019 =
* Shop Page Design Fixed
* Screenshot Changed
* Minor CSS Fixed
* Added Page Template For Elementor Page Builder
* Added Compatibility For Gutentor

= 1.0.7 - December 6 2019 =
* Sticky Menu fixed
* Responsive View on Small screen fixed
* Post template sidebar issues
* Minor CSS issues fixed

= 1.0.6 - December 1 2019 =
* Keyboard Navigation for menu fixed
* Reviewer Issues Fixed

= 1.0.5 - November 27 2019 =
* Page Error Fixed

= 1.0.4 - November 27 2019 =
* Reviewer Issues Fixed
* Checked with WP 5.3
* Changed Demo Import Method
* Removed TGM Recommendation

= 1.0.3 - November 08 2019 =
...
== Images ==
* Screenshot - [Slider] - https://stocksnap.io/photo/U2CLPC1BKA - CCO
...
* Screenshot - [Default Slider] - https://stocksnap.io/photo/TE9BDY8EYB - CCO